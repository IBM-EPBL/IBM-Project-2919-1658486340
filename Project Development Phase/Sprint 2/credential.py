{
  "connection": {
    "cli": {
      ...
      "composed": [
        "db2 -u txs49042 -p cNEKMzATxRu70nLU --ssl --sslCAFile 1cbbb1b6-3a1a-4d49-9262-3102a8f7a7c8 --authenticationDatabase admin --host 125f9f61-9715-46f9-9399-c8177b21803b.c1ogj3sd0tgtu0lqde00.databases.appdomain.cloud:30426"
      ],
      "environment": {},
      "type": "cli"
    },
    "db2": {
      ...
      "composed": [
        "db2://txs49042:cNEKMzATxRu70nLU@125f9f61-9715-46f9-9399-c8177b21803b.c1ogj3sd0tgtu0lqde00.databases.appdomain.cloud:30426/bludb?authSource=admin&replicaSet=replset"
      ],
      "database": "bludb",
      "host_ros": [
        "125f9f61-9715-46f9-9399-c8177b21803b.c1ogj3sd0tgtu0lqde00.databases.appdomain.cloud:31048"
      ],
      "hosts": [
        {
      ...
      "jdbc_url": [
        "jdbc:db2://125f9f61-9715-46f9-9399-c8177b21803b.c1ogj3sd0tgtu0lqde00.databases.appdomain.cloud:30426/bludb:user=<userid>;password=<your_password>;sslConnection=true;"
      ],
      "path": "/bludb",
      "query_options": {
        "authSource": "admin",
  ...
  "instance_administration_api": {
    "deployment_id": "crn:v1:bluemix:public:dashdb-for-transactions:us-south:a/985cff4f31bc43048994b3f3b9558779:cdb71d18-4cbf-4e72-99fd-acdd7d81c646::",
    "instance_id": "crn:v1:bluemix:public:dashdb-for-transactions:us-south:a/985cff4f31bc43048994b3f3b9558779:cdb71d18-4cbf-4e72-99fd-acdd7d81c646::",
